...
export default function Cards() {
  return (
    <div className="w-screen min-h-screen bg-white">
        <h1 style={{color:"yellow"}} className="pt-5 text-[100px] text-center">Vendors</h1>
        <div className=" px-5 flex flex-wrap gap-5 justify-center py-4">
      {cards.map((card, index) => (
        <div key={index} className="min-w-[20vw]">
          <Card
            image={card.image}
            title={card.title}
